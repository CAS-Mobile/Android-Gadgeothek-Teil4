 ...
 *
 * Todo: LibraryServiceConsumer baseclass for all Activities which handles all the binding, etc.
 *
 * Aufgabe: Service erstellen, refactoring!
 *
 * Aufgabe letzter Tag: Libraries einbinden, ButterKnife, Retrofit
 */
